...
export const translations = {
  en: {
    ...
    pro: {
      ...
      toneAuto: "Auto (let our strategists choose)",
      toneOptions: {
      ...
      goalAuto: "Auto (let our strategists choose)",
      goalOptions: {
      ...
      platformAuto: "Auto (general / all platforms)",
      platformOptions: {
        instagram: "Instagram",
        facebook: "Facebook",
        tiktok: "TikTok",
    ...
    planFeatures: {
      ...
      // pro/premium: "features" مصفوفة (بدل جملة وصفية واحدة) تُعرَض كبطاقة مبنية ببنود
      // واضحة (راجع App.js، قسم "Luxury Structured Tier Cards"). الأرقام الحرفية (30 يوماً/5
      // تسليمات، 90 يوماً/10 تسليمات) مأخوذة من الحدود المُفعَّلة فعلياً في النظام —
      // PLAN_LIMITS.pro/premium في backend/server.js (~السطر 430)، ومطابقة تماماً لـ
      // PLAN_MAX_DAYS/PLAN_MAX_GENERATIONS في frontend/src/App.js (~السطر 33-34). نص وصفي
      // بحت، لا يغيّر أي منطق أو حد فعلي في التطبيق. emoji لم تعد مستخدَمة لهاتين الباقتين —
      // استُبدلت بعلامة ذهبية بسيطة (◆) تُرسَم في App.js نفسه بدل تخزينها كنص مترجَم.
      pro: {
        label: "Boutique Campaign:",
        features: [
          "30-Day Strategy Timeline (Exact Limit)",
          "5 Campaign Deliverables / Month (Exact Limit)",
          "Multi-Language Deployment",
          "CSV / Excel Strategy Export",
        ],
      },
      premium: {
        label: "Full Agency Retainer:",
        features: [
          "Up to 90-Day Strategy Timeline (Exact Limit)",
          "10 Comprehensive Deliverables / Month (Exact Limit)",
          "Executive Creative Direction & Visual Prompts",
          "Omnichannel Content Repurposing (Everything in Pro)",
        ],
      },
    },
    upsell: {
    ...
    freeUpsell: {
      ...
      coffee: {
        ...
        description:
          "Your morning coffee costs you every single day, while a professional, well-planned 30-day content calendar saves you 30 hours of brainstorming for less.",
      ...
      lockedCards: {
        ...
        brandRetainer: {
          title: "90-Day Full Brand Retainer & Creative Repurposing",
          tier: "Retainer Exclusive",
        },
      },
    },
  ...
  ar: {
    ...
    pro: {
      ...
      toneAuto: "تلقائي (اترك استراتيجيينا يختارون)",
      toneOptions: {
      ...
      goalAuto: "تلقائي (اترك استراتيجيينا يختارون)",
      goalOptions: {
      ...
      platformAuto: "تلقائي (عام / كل المنصات)",
      platformOptions: {
        instagram: "إنستغرام",
        facebook: "فيسبوك",
        tiktok: "تيك توك",
    ...
    planFeatures: {
      ...
      pro: {
        label: "حملة مخصصة:",
        features: [
          "مخطط استراتيجي حتى 30 يوماً (حد أقصى مضبوط)",
          "5 حزم تسليم شهرياً (حد أقصى مضبوط)",
          "دعم نشر متعدد اللغات",
          "تصدير الاستراتيجية بصيغة Excel / CSV",
        ],
      },
      premium: {
        label: "إدارة تسويقية شاملة:",
        features: [
          "مخطط استراتيجي حتى 90 يوماً (حد أقصى مضبوط)",
          "10 حزم تسليم شاملة شهرياً (حد أقصى مضبوط)",
          "توجيه إبداعي تنفيذي ومحفزات بصرية احترافية",
          "إعادة تدوير المحتوى عبر جميع القنوات (كل ميزات الحملة المخصصة)",
        ],
      },
    },
    upsell: {
    ...
    freeUpsell: {
      ...
      coffee: {
        ...
        description:
          "فنجان القهوة الصباحي يكلفك يومياً، بينما الحصول على خطة محتوى احترافية ومدروسة لمدة 30 يوماً سيوفر لك 30 ساعة من التفكير بثمن أقل.",
      ...
      lockedCards: {
        ...
        brandRetainer: {
          title: "إدارة علامة تجارية شاملة لمدة 90 يوماً مع إعادة تدوير إبداعي",
          tier: "حصرياً لباقة Retainer",
        },
      },
    },
  ...
  fr: {
    ...
    pro: {
      ...
      toneAuto: "Automatique (laisser nos stratèges choisir)",
      toneOptions: {
      ...
      goalAuto: "Automatique (laisser nos stratèges choisir)",
      goalOptions: {
      ...
      platformAuto: "Automatique (générale / toutes plateformes)",
      platformOptions: {
        instagram: "Instagram",
        facebook: "Facebook",
        tiktok: "TikTok",
    ...
    planFeatures: {
      ...
      pro: {
        ...
        features: [
          "Chronologie stratégique sur 30 jours (limite exacte)",
          "5 livrables de campagne / mois (limite exacte)",
          "Déploiement multilingue",
          "Export de la stratégie en CSV / Excel",
        ],
      },
      premium: {
        label: "Forfait Agence Complet :",
        features: [
          "Chronologie stratégique jusqu'à 90 jours (limite exacte)",
          "10 livrables complets / mois (limite exacte)",
          "Direction créative exécutive et prompts visuels",
          "Recyclage de contenu omnicanal (tout ce qui est inclus dans Campagne Sur Mesure)",
        ],
      },
    },
    upsell: {
    ...
    freeUpsell: {
      ...
      coffee: {
        ...
        description:
          "Votre café du matin vous coûte chaque jour, alors qu'un calendrier de contenu professionnel et bien pensé sur 30 jours vous fait économiser 30 heures de réflexion, pour moins cher.",
      ...
      lockedCards: {
        ...
        brandRetainer: {
          title: "Gestion de marque complète sur 90 jours avec recyclage créatif",
          tier: "Exclusif Forfait Retainer",
        },
      },
    },
